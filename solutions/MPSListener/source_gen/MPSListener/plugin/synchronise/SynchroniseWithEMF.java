...
public class SynchroniseWithEMF {
  ...
  public SynchroniseWithEMF(fileData emfFileData, SNode modelInstance) {
    ...
    this.mpsFileData = new MPSListener.plugin.dataClasses.mps.fileData(this.emfFileData.getId());
    this.log = Logger.getLogger(SynchroniseWithEMF.class.getSimpleName());
    start();
  }
