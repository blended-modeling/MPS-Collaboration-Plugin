...
import MPSListener.plugin.MPS_synchroniseWithEMF;
...
public class EMF_parser {
  ...
  public EMF_fileData parseFileData(HashMap<String, Object> fileMap) {
    EMF_fileData fileData = new EMF_fileData(as_8lxi7k_a0a0a0a8(fileMap.get("$type"), String.class), as_8lxi7k_a1a0a0a8(fileMap.get("$id"), String.class), as_8lxi7k_a2a0a0a8(fileMap.get("name"), String.class), getInputs(as_8lxi7k_a0d0a0a0i(fileMap.get("input"), List.class)), getOutputs(as_8lxi7k_a0e0a0a0i(fileMap.get("output"), List.class)), getStates(as_8lxi7k_a0f0a0a0i(fileMap.get("states"), List.class)));
    return fileData;
  }

  public List<EMF_input> getInputs(List<Object> inputs) {
    List<EMF_input> extractedInputs = new ArrayList<EMF_input>();
    for (Object object : inputs) {
      extractedInputs.add(new EMF_input(as_8lxi7k_a0a0a0a0b0k(object, HashMap.class)));
    }
    return Collections.unmodifiableList(extractedInputs);
  }

  public List<EMF_output> getOutputs(List<Object> inputs) {
    List<EMF_output> extractedOutputs = new ArrayList<EMF_output>();
    for (Object object : inputs) {
      extractedOutputs.add(new EMF_output(as_8lxi7k_a0a0a0a0b0m(object, HashMap.class)));
    }
    return Collections.unmodifiableList(extractedOutputs);
  }

  public List<EMF_states> getStates(List<Object> inputs) {
    List<EMF_states> extractedStates = new ArrayList<EMF_states>();
    for (Object object : inputs) {
      extractedStates.add(new EMF_states(as_8lxi7k_a0a0a0a0b0o(object, HashMap.class)));
    }
  ...
  public static void main(String[] args) {
    ...
    EMF_fileData fileData = emf_synchroniseModel.parseFileData(map);
    List<EMF_input> list = emf_synchroniseModel.getInputs(as_8lxi7k_a0a0a6a02(map.get("input"), List.class));
